...
/***/ function(module, exports, __webpack_require__) {
	...
	var AutosuggestContainer = function (_Component) {
	  ...
	  function AutosuggestContainer(props) {
	    ...
	    var alwaysRenderSuggestions = props.alwaysRenderSuggestions;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutowhatever = __webpack_require__(32);
	  ...
	  _createClass(Autosuggest, [{
	    ...
	    value: function componentWillReceiveProps(nextProps) {
	      if (nextProps.suggestions !== this.props.suggestions) {
	        ...
	        var alwaysRenderSuggestions = nextProps.alwaysRenderSuggestions;
	        var value = inputProps.value;


	        if (alwaysRenderSuggestions || isCollapsed && lastAction !== 'click' && lastAction !== 'enter' && suggestions.length > 0 && shouldRenderSuggestions(value)) {
	          revealSuggestions();
	        }
	      }
	    }
